...
public class UserService {
    ...
    // 회원가입 처리
    public UserSignUpResponseDTO create(UserSignUpRequestDTO dto, String imagePath) {
        ...
        User saved = userRepository.save(dto.toEntity(passwordEncoder, imagePath));
